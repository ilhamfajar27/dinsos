...
<head>
  ...
  <title>Dinas Sosial Tabalong</title>
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Program</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><a href="layanandinsos.php">Pelayanan Dinas Sosial</a></li>  
            </ul>
          </li>
          ...
          <li><a class="nav-link scrollto" href="">Daftar Penerima Bantuan</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          ...
          <h1 data-aos="fade-up">Dinas Sosial Kabupaten Tabalong</h1>
        ...
        <div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="200">
          <img src="assets/img/logo1.png" width="400px" class="img-fluid logo-custom" alt="">
        </div>
      </div>
    </div>
